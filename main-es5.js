...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppWelcomeWelcomeComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<h4>ĐĂNG NHẬP THÀNH CÔNG</h4>\n<a href=\"#\" (click)=\"onLogout()\">LOGOUT</a>\n<!-- <ul>\n    <li *ngFor=\"let user of users\"> \n        <p>{{user.id}}</p>\n        <p>{{user.email}}</p>\n        <p>{{user.name}}</p>\n        <p>{{user.password}}</p>\n        <p>{{user.role}}</p>\n    </li>\n</ul>\n<table style=\"width:100%\">\n    <tr>\n      <th>Id</th>\n      <th>Email</th>\n      <th>Name</th>\n      <th>Password</th>\n      <th>Role</th>\n    </tr>\n    <tr *ngFor=\"let user of users\">\n      <td>{{ user.id }}</td>\n      <td>{{ user.email }}</td>\n      <td>{{ user.name }}</td>\n      <td>{{ user.password }}</td>\n      <td>{{ user.role }}</td>\n    </tr>\n  </table> -->\n";
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _service_authen_gaurd_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./service/authen-gaurd.service */
    "./src/app/service/authen-gaurd.service.ts");
    /* harmony import */


    var _service_service_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_6__["LoginComponent"], _welcome_welcome_component__WEBPACK_IMPORTED_MODULE_7__["WelcomeComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HttpClientModule"]],
  ...
  function srcAppLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function LoginComponent(router, authenticationservice, service, http) {
      ...
      _createClass(LoginComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {// const url = 'http://localhost:9999/getAllAccount';
        ...
        key: "onLogin",
        value: function onLogin(formSignIn) {
          var _this = this;

          // console.log(formSignIn.value)
          var url = 'http://localhost:9999/api/v1/XXXXXXXXXX';
  ...
  /***/
  function srcAppServiceAuthenGaurdServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AuthenGaurdService", function () {
      return AuthenGaurdService;
    });
    /* harmony import */
    ...
    var AuthenGaurdService =
    /*#__PURE__*/
    function () {
      function AuthenGaurdService(anthenService, router) {
        _classCallCheck(this, AuthenGaurdService);

        this.anthenService = anthenService;
        this.router = router;
      }

      _createClass(AuthenGaurdService, [{
        key: "canActivate",
    ...
    AuthenGaurdService.ctorParameters = function () {
      return [{
    ...
    AuthenGaurdService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], AuthenGaurdService);
    /***/
  },
  ...
  function srcAppServiceAuthenticationServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function AuthenticationService(http) {
        ...
        this.http = http;
        this.isUserLogin = false; // this.currentUserSubject = new BehaviorSubject<User>(JSON.parse(localStorage.getItem('currentUser'))); 
  ...
  function srcAppWelcomeWelcomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function WelcomeComponent(authen, http, route) {
      ...
      _createClass(WelcomeComponent, [{
        ...
        value: function onLogout() {
          this.authen.logOut();
          this.route.navigate(['']); // console.log('Log out')
        }
      }]);
